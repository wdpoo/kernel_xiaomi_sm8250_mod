...
if [ $KSU_ENABLE -eq 1 ]; then
    echo "KSU is enabled"
    curl -LSs "https://raw.githubusercontent.com/wdpoo/SukiSU-Ultra/main/kernel/setup.sh" | bash -s WDGPKII
else
...
local_version_date_str="-WDGPKII-$(date +%Y%m%d)-${GIT_COMMIT_ID}-perf"
